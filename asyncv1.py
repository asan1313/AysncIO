...
#this improved the downloading time but time for processing was still large 
# due to it being a cpu bound process
#threading is used as download image is still synchronous func
